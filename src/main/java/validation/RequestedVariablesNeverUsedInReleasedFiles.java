...
public class RequestedVariablesNeverUsedInReleasedFiles implements ValidationRuleInterface{

	@Override
	public String getName() {
		// TODO Auto-generated method stub
		return "Requested Variables Not Found In Any Released File";
	}
	...
	public JPanel getSimpleResult(String[] args, Model model) {
		...
		ArrayList<Database> variablesList =  (ArrayList<Database>) new RequestedVariablesNeverUsedInReleasedFiles ().getViolations(args, model);
